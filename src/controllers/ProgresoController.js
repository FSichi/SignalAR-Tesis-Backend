...
class ProgresoController {
    ...
    deleteProgresoSeccion = async (req, res) => {

        const { id } = req.params;
        try {
            const progreso = await this._service.deleteProgresoSeccion(id);
            handleSuccessResponse(res, 200, progreso);
        } catch (error) {
            handleErrorResponse(res, error);
        }
    ...
    deleteProgresoEvaluacion = async (req, res) => {

        const { id } = req.params;
        try {
            const progreso = await this._service.deleteProgresoEvaluacion(id);
            handleSuccessResponse(res, 200, progreso);
        } catch (error) {
            handleErrorResponse(res, error);
        }
